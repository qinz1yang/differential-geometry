...
theorem riemannTopOrderPairing_cancellation
    ...
    (-2 : Real) • operatorFieldApply (I := I) (M := M) g 2 2
        (ricciPalatiniHalfCoefficient (I := I) (M := M) g gm) W +
      (operatorFieldApply (I := I) (M := M) g 2 2 C₀ W +
        operatorFieldApply (I := I) (M := M) g 4 2 C₂
          (iteratedCovGrad (I := I) g 0 2 2 W)) =
      (-2 : Real) • operatorFieldApply (I := I) (M := M) g 2 2
...
theorem deTurckLieTopOrderPairing_inner
  ...
  rw [deTurckLieTopOrderPairingFamily, deTurckLieTopOrderPairingAdjoint,
...
theorem deTurckLieTopOrderPairing_green
    (g : SmoothRiemannianMetric I M) (T : SmoothCcTensor g 0 2)
    {delta : Real}
    (hdelta : metricCauchySchwarzBound (I := I) (M := M) g
      (ccTensorBilinSymm (I := I) g T) delta)
    ...
    (⟪T, operatorFieldApply (I := I) (M := M) g 2 2
      ...
      -⟪covDivergence (I := I) (M := M) g 3
          (deTurckLieTopOrderPairingAdjoint (I := I) (M := M) g T hdelta hdeltaZ
            q epsilon s),
  ...
  calc
    (⟪T, operatorFieldApply (I := I) (M := M) g 2 2
      ...
      exact deTurckLieTopOrderPairing_inner (I := I) (M := M) g T hdelta hdeltaZ
        q epsilon s
...
theorem exists_deTurckLie_top_order_pairing_decomposition
        ...
        (∀ s ∈ Set.Icc (0 : Real) 1,
          metricDependentLowOrderAction (I := I) (M := M) g
            ...
            (-2 : Real) • operatorFieldApply (I := I) (M := M) g 2 2
              ...
              operatorFieldApply (I := I) (M := M) g 2 2
                (deTurckLieTopOrderPairingFamily (I := I) (M := M) g W hdelta
  ...
  have hnormal : ∀ s ∈ Set.Icc (0 : Real) 1,
      metricDependentLowOrderAction (I := I) (M := M) g
        ...
        (-2 : Real) • operatorFieldApply (I := I) (M := M) g 2 2
          ...
          operatorFieldApply (I := I) (M := M) g 3 2
            ...
            (iteratedCovGrad (I := I) g 0 2 1 W) +
          operatorFieldApply (I := I) (M := M) g 2 2
            (deTurckLieTopOrderPairingFamily (I := I) (M := M) g W hdelta hdeltaZ
              q epsilon s) W := by
    intro s hs
    ...
    have hlieApply := deTurckLieTopOrderPairing_apply (I := I) (M := M)
