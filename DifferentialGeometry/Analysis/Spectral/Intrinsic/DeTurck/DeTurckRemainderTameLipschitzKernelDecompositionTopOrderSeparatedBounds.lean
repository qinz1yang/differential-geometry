...
private lemma riemannianFiberNormSq_neg (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma sqrt_riemannianFiberNormSq_sub_le (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
...
private lemma domDomCongrSection_add (g : SmoothRiemannianMetric I M) {s : ℕ}
...
omit [NeZero (Module.finrank ℝ E)] [I.Boundaryless] in
omit [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma domDomCongrSection_smul (g : SmoothRiemannianMetric I M) {s : ℕ}
...
omit [NeZero (Module.finrank ℝ E)] [I.Boundaryless] in
omit [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma domDomCongrSection_comp (g : SmoothRiemannianMetric I M) {s : ℕ}
...
omit [NeZero (Module.finrank ℝ E)] [I.Boundaryless] in
omit [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma domDomCongrSection_refl (g : SmoothRiemannianMetric I M) {s : ℕ}
...
private lemma domDomCongrSection_symmS (g₀ : SmoothRiemannianMetric I M)
  ...
  rw [domDomCongrSection_add (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 2) 1),
    ...
    domDomCongrSection_comp (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 2) 1)
...
private lemma zeroTensor_eq_smul_unitTensor (x : M)
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma riemannianFiberNormSq_add_expand (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
    (a b : TensorRSSpace r s I x) :
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma riemannianFiberNormSq_add_add_expand (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
  ...
  rw [riemannianFiberNormSq_add_expand (I := I) (M := M) g r s x (a + b) c,
    riemannianFiberNormSq_add_expand (I := I) (M := M) g r s x a b]
  rw [TensorRSSpace.toModel_add, tensorInnerPointwise_add_left]
  ring

omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma riemannianFiberNormSq_add_sub_expand (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
    (a b c : TensorRSSpace r s I x) :
    riemannianFiberNormSq (I := I) (M := M) g r s x (a + b - c) =
      riemannianFiberNormSq (I := I) (M := M) g r s x a
        + riemannianFiberNormSq (I := I) (M := M) g r s x b
  ...
  have hsub : a + b - c = a + b + (-1 : ℝ) • c := by
    ...
    abel
  rw [hsub]
  rw [riemannianFiberNormSq_add_add_expand (I := I) (M := M) g r s x a b ((-1 : ℝ) • c)]
...
theorem riemannianFiberNormSq_iteratedCovGrad_koszulCovecCc_le_iteratedCovGrad_symmetrization_succ
  ...
  have hE : domDomCongrSection (I := I) g₀ (finRotate 3) B =
    ...
    rw [← domDomCongrSection_comp (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 3) 1)
  ...
  have hab_sec : domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2)
      ...
      domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2) B
        + domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B := by
    rw [domDomCongrSection_add (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 3) 2) B
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)]
    rw [domDomCongrSection_comp (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 3) 2)
  ...
  have hbc_sec : domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1)
    ...
    rw [domDomCongrSection_add (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 3) 1) B
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)]
    rw [domDomCongrSection_comp (I := I) (M := M) g₀ (Equiv.swap (0 : Fin 3) 1)
      (Equiv.swap (0 : Fin 3) 1) B]
    rw [show (Equiv.swap (0 : Fin 3) 1).trans (Equiv.swap (0 : Fin 3) 1) =
      Equiv.refl (Fin 3) from by decide]
    rw [domDomCongrSection_refl (I := I) (M := M) g₀ B]
  have hac_sec : domDomCongrSection (I := I) g₀ (Equiv.swap (1 : Fin 3) 2)
      (B + domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B) =
      B + domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2) B := by
    rw [domDomCongrSection_add (I := I) (M := M) g₀ (Equiv.swap (1 : Fin 3) 2) B
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)]
    rw [hπ]
    rw [domDomCongrSection_comp (I := I) (M := M) g₀ (Equiv.swap (1 : Fin 3) 2)
      (Equiv.swap (0 : Fin 3) 1) B]
    ...
    rw [hπ]
  rw [hkC]
  rw [DifferentialGeometry.Analysis.Spectral.iteratedCovGrad_smul (I := I) (M := M) g₀ 0 3 u]
  ...
  rw [DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_sub_apply (I := I) (M := M) g₀
    ...
    DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_add_apply (I := I) (M := M) g₀
      (r := 0) (s := 3 + u)]
  rw [hE]
  have hexp := riemannianFiberNormSq_add_sub_expand (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
  ...
  have habc := riemannianFiberNormSq_add_add_expand (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2) B)).toSection x)
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)).toSection x)
  ...
  have hpos := riemannianFiberNormSq_nonneg (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      ...
      + (iteratedCovGrad (I := I) g₀ 0 3 u
        (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)).toSection x
      + (iteratedCovGrad (I := I) g₀ 0 3 u B).toSection x)
  have e_ab := riemannianFiberNormSq_add_expand (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2) B)).toSection x)
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)).toSection x)
  have e_bc := riemannianFiberNormSq_add_expand (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 1) B)).toSection x)
    ((iteratedCovGrad (I := I) g₀ 0 3 u B).toSection x)
  have e_ac := riemannianFiberNormSq_add_expand (I := I) (M := M) g₀ 0 (3 + u) x
    ((iteratedCovGrad (I := I) g₀ 0 3 u
      (domDomCongrSection (I := I) g₀ (Equiv.swap (0 : Fin 3) 2) B)).toSection x)
    ((iteratedCovGrad (I := I) g₀ 0 3 u B).toSection x)
...
private def orderZeroKernelOutputPermutation3201 : Equiv.Perm (Fin 4) :=
  ⟨![3, 2, 0, 1], ![2, 3, 1, 0], by decide, by decide⟩

private def orderZeroKernelOutputPermutation2301 : Equiv.Perm (Fin 4) :=
  ⟨![2, 3, 0, 1], ![2, 3, 0, 1], by decide, by decide⟩

private def orderZeroKernelOutputPermutation3102 : Equiv.Perm (Fin 4) :=
  ⟨![3, 1, 0, 2], ![2, 1, 3, 0], by decide, by decide⟩

private def orderZeroKernelOutputPermutation1302 : Equiv.Perm (Fin 4) :=
  ⟨![1, 3, 0, 2], ![2, 0, 3, 1], by decide, by decide⟩

private def orderZeroKernelOutputPermutation1203 : Equiv.Perm (Fin 4) :=
  ⟨![1, 2, 0, 3], ![2, 0, 1, 3], by decide, by decide⟩

private def orderZeroKernelOutputPermutation2103 : Equiv.Perm (Fin 4) :=
  ⟨![2, 1, 0, 3], ![2, 1, 0, 3], by decide, by decide⟩

private def orderZeroKernelOutputPermutation3012 : Equiv.Perm (Fin 4) :=
  ⟨![3, 0, 1, 2], ![1, 2, 3, 0], by decide, by decide⟩

private def orderZeroKernelOutputPermutation2013 : Equiv.Perm (Fin 4) :=
  ⟨![2, 0, 1, 3], ![1, 2, 0, 3], by decide, by decide⟩

private def orderZeroKernelMiddlePermutation102 : Equiv.Perm (Fin 3) :=
  ⟨![1, 0, 2], ![1, 0, 2], by decide, by decide⟩

private def orderZeroKernelMiddlePermutation120 : Equiv.Perm (Fin 3) :=
  ⟨![1, 2, 0], ![2, 0, 1], by decide, by decide⟩

omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [SigmaCompactSpace M] in
private theorem slotPermutationCc0Fib_contMDiff (_g₀ : SmoothRiemannianMetric I M) {d : ℕ}
    (ρ : Equiv.Perm (Fin d)) :
...
private def slotPermutationCc0 (g₀ : SmoothRiemannianMetric I M) {d : ℕ} (ρ : Equiv.Perm (Fin d)) :
...
private theorem reindexCoeffFibGen_innerContractionSwapPerm_eq_comp
    ...
    DifferentialGeometry.Analysis.Parabolic.TensorSpectral.reindexCoeffFibGen
      ...
      A.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
        (I := I) DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm2_10 x) := by
...
private theorem order0KernelField_eq_arm_combination (g₀ g₁ : SmoothRiemannianMetric I M) :
    DifferentialGeometry.Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
      ...
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3201)
          (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
            (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField
            (I := I) g₀ g₁)
        ...
        + ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
          (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3102)
            (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
              (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField
              (I := I) g₀ g₁)
              (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3
            ...
            (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
              ...
              (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
                ...
                (Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
                  ...
                  DifferentialGeometry.Analysis.Parabolic.TensorSpectral.innerContractionSwapPerm
        + ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
          (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelOutputPermutation1203)
            (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
              (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField
              (I := I) g₀ g₁)
              (Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
  ...
  rw [show orderZeroKernelOutputPermutation3201 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_3201 from rfl,
    show orderZeroKernelOutputPermutation2301 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_2301 from rfl,
    show orderZeroKernelOutputPermutation3102 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_3102 from rfl,
    show orderZeroKernelOutputPermutation1302 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_1302 from rfl,
    show orderZeroKernelOutputPermutation1203 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_1203 from rfl,
    show orderZeroKernelOutputPermutation2103 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_2103 from rfl,
    show orderZeroKernelOutputPermutation3012 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_3012 from rfl,
    show orderZeroKernelOutputPermutation2013 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm4_2013 from rfl,
    show orderZeroKernelMiddlePermutation102 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm3_102 from rfl,
    show orderZeroKernelMiddlePermutation120 =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.perm3_120 from rfl]
...
private theorem operatorFieldComp24_riemannianFiberNormSq_eq (g₀ : SmoothRiemannianMetric I M)
    ...
    riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + q) x
        ((iteratedCovGrad (I := I) g₀ 2 4 q
          (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
            (slotPermutationCc0 (I := I) (M := M) g₀ σ) W)).toSection x) =
      riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + q) x
  ...
  refine riemannianFiberNormSq_iteratedCovGrad_rs_eq_of_section_domDomCongr (I := I) (M := M) g₀ 2 4
    σ
    W (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4 (slotPermutationCc0 (I := I) (M := M) g₀ σ) W)
    (fun y d => ?_) q x
  have hy : (show Tensor0SSpace 2 I y →L[ℝ] Tensor0SSpace 4 I y from
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        (slotPermutationCc0 (I := I) (M := M) g₀ σ) W).toSection y) d =
...
private theorem operatorFieldComp23_riemannianFiberNormSq_eq (g₀ : SmoothRiemannianMetric I M)
  ...
  refine riemannianFiberNormSq_iteratedCovGrad_rs_eq_of_section_domDomCongr (I := I) (M := M) g₀ 2 3
    σ
    W (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3 (slotPermutationCc0 (I := I) (M := M) g₀ σ) W)
    (fun y d => ?_) q x
...
private lemma sum_antidiagonalTupleGrid_eq_boundedFactorGridWindow (b : ℕ → ℝ) {K W : ℕ} (hW : W ≤ K + 1) :
...
private theorem connectionDifferenceContravariantInsertionField_le (g₀ g₁ : SmoothRiemannianMetric I M) (n : ℕ) (x : M) :
  ...
  refine le_trans (riemannianFiberNormSq_iteratedCovGrad_slotExtend_le (I := I) (M := M) g₀ 2 3
    (slotExtend (I := I) (M := M) g₀ 1 2 (connectionDifferenceSection (I := I) g₁ g₀)) n x) ?_
...
private theorem connectionDifferenceGradContrInsertionField_le (g₀ g₁ : SmoothRiemannianMetric I M) (i : ℕ) (x : M) :
  ...
  refine le_trans (riemannianFiberNormSq_iteratedCovGrad_slotExtend_le (I := I) (M := M) g₀ 1 3
    (covGrad (I := I) (M := M) g₀ 1 2 (connectionDifferenceSection (I := I) g₁ g₀)) i x) ?_
  refine mul_le_mul_of_nonneg_left ?_ (Nat.cast_nonneg _)
...
private lemma three_remainder_young_bound {T e btop c1 c2 c3 w : ℝ}
  ...
  have hTuv : T ≤ (u + v) ^ 2 := by
    ...
    exact hsq
  have hyoung := DifferentialGeometry.Analysis.add_sq_le_young u v (1 / 2) (by norm_num)
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma sqrt_riemannianFiberNormSq_six_add_two_sub_le (g : SmoothRiemannianMetric I M) (r s : ℕ) (x : M)
...
omit [FiniteDimensional ℝ E] [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless]
    [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma metricComparisonEndomorphism_frame_sum_sq (g : SmoothRiemannianMetric I M) (x : M)
...
omit [FiniteDimensional ℝ E] [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless]
    [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma fiberNormSqComponent_operatorFieldComposition_eq
...
private lemma sum_fin_one_function {α : Type*} [AddCommMonoid α] {n : ℕ} (f : (Fin 1 → Fin n) → α) :
...
theorem riemannianFiberNormSq_operatorFieldComposition_sharpFlatEndoCc_contravariantSlot_op_le (g₀ g₁ : SmoothRiemannianMetric I M)
  ...
  have hWop : ∀ u : TangentSpace I x,
    ...
    intro u
    have hs := DifferentialGeometry.Analysis.Sobolev.TensorHilbert.sqrt_inner_metricComparisonEndomorphism_le
      (I := I) (M := M) g₀ g₁
    ...
    calc g₀.inner x
          ...
          (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism (I := I) g₀ g₁ x
            u)
        = Real.sqrt (g₀.inner x
            (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism (I := I) g₀ g₁
              x u)
            (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism (I := I) g₀ g₁
              x u)) ^ 2 :=
          hsq.symm
      ...
      _ = (1 / (1 - δ₀)) ^ 2 * g₀.inner x u u := by
          rw [mul_pow, hsqu]
  rw [operatorFieldComposition_toSection (I := I) (M := M) g₀ 1 1 c D
  ...
  have hcomp : ∀ (K : Fin 1 → Fin n) (J : Fin c → Fin n),
    ...
    fun K J => fiberNormSqComponent_operatorFieldComposition_eq (I := I) (M := M) g₀ 1 1 c x
  ...
  have hsfe_val : ∀ K Pf : Fin 1 → Fin n,
      fiberNormSqComponent (I := I) (M := M) g₀ x 1 1
          ((DifferentialGeometry.Analysis.Parabolic.TensorSpectral.sharpFlatEndoCc (I := I) g₀
            g₁).toSection x) n e K Pf =
        g₀.inner x (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism
          (I := I) g₀ g₁ x (e (K 0))) (e (Pf 0)) := by
    intro K Pf
    rw [fiberNormSqComponent_sharpFlatEndoCc (I := I) (M := M) g₀ g₁ x e K Pf]
    rw [DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism_apply (I := I) g₀ g₁ x
      (e (K 0))]
      ...
      (∑ Pf : Fin 1 → Fin n,
        fiberNormSqComponent (I := I) (M := M) g₀ x 1 1
            ((DifferentialGeometry.Analysis.Parabolic.TensorSpectral.sharpFlatEndoCc (I := I) g₀
              g₁).toSection x) n e K Pf *
          fiberNormSqComponent (I := I) (M := M) g₀ x 1 c (D.toSection x) n e Pf J) =
      g₀.inner x u (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism
        (I := I) g₀ g₁ x (e (K 0))) := by
    intro K
    rw [sum_fin_one_function (fun Pf : Fin 1 → Fin n =>
      fiberNormSqComponent (I := I) (M := M) g₀ x 1 1
          ((DifferentialGeometry.Analysis.Parabolic.TensorSpectral.sharpFlatEndoCc (I := I) g₀
            g₁).toSection x) n e K Pf *
        fiberNormSqComponent (I := I) (M := M) g₀ x 1 c (D.toSection x) n e Pf J)]
  ...
  rw [Finset.sum_congr rfl (fun K (_ : K ∈ Finset.univ) => by rw [hinner_sum K] :
    ∀ K ∈ Finset.univ, ((∑ Pf : Fin 1 → Fin n,
      ...
      (g₀.inner x u (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism
        (I := I) g₀ g₁ x (e (K 0)))) ^ 2)]
  rw [sum_fin_one_function (fun K : Fin 1 → Fin n =>
    (g₀.inner x u (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism (I := I)
      g₀ g₁ x (e (K 0)))) ^ 2)]
  refine le_trans (gFrame_adjoint_parseval_le (I := I) (M := M) g₀ x
    (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism (I := I) g₀ g₁ x)
      ((1 / (1 - δ₀)) ^ 2) (by positivity)
    hWop e hpars u) ?_
  rw [hu_def, metricComparisonEndomorphism_frame_sum_sq (I := I) (M := M) g₀ x e y horth]
...
omit [FiniteDimensional ℝ E] [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless]
    [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma slotPermutation_coframeS (g : SmoothRiemannianMetric I M) (x : M)
...
omit [FiniteDimensional ℝ E] [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless]
    [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma fiberNormSqComponent_comp_slotPermutation (g : SmoothRiemannianMetric I M) (x : M)
  ...
  have hread2 : fiberNormSqComponent (I := I) (M := M) g x d s
    ...
    unfold fiberNormSqComponent coframeS
    rfl
  rw [hread, hread2, slotPermutation_coframeS (I := I) (M := M) g x e d ρ Q]

omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma cometricDoubleTrace_component_eq (g₀ g₁ : SmoothRiemannianMetric I M) (x : M)
    {n : ℕ} (e : Fin n → TangentSpace I x)
  ...
  rw [← Finset.mul_sum]
  rw [cometric_dual_frame_sum_inner_collapse (I := I) (M := M) g₀ g₁ x (e (Q 0)) (e (Q 1))]
  rw [horth (Q 2) (L 0), horth (Q 3) (L 1)]
  rw [DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism_apply
    (I := I) g₀ g₁ x (e (Q 1))]

private lemma pair_delta_sum_right {nn : ℕ} (a b : Fin nn) :
    (∑ L : Fin 2 → Fin nn,
...
private lemma sum_fin_four_split {nn : ℕ} (F : (Fin 4 → Fin nn) → ℝ) :
    ∑ Q : Fin 4 → Fin nn, F Q =
...
private lemma cons_indices {nn : ℕ} (q0 q1 : Fin nn) (Q2 : Fin 2 → Fin nn) :
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma singleTrace_functional_sq_le (g₀ g₁ : SmoothRiemannianMetric I M) (x : M)
    {n : ℕ} (e : Fin n → TangentSpace I x)
    (horth : ∀ a b : Fin n, g₀.inner x (e a) (e b) = if a = b then (1 : ℝ) else 0)
    (V : (Fin 4 → Fin n) → ℝ) :
    ∑ L : Fin 2 → Fin n,
  ...
  have hcomp : ∀ (Q : Fin 4 → Fin n) (L : Fin 2 → Fin n),
    ...
    cometricDoubleTrace_component_eq (I := I) (M := M) g₀ g₁ x e horth Q L
  ...
  have hmsum : ∀ L : Fin 2 → Fin n,
    ...
    intro L
    rw [sum_fin_four_split (fun Q : Fin 4 → Fin n => (m (Q 0) (Q 1)) ^ 2 * χ Q L)]
    ...
    have hval : ∀ Q2 : Fin 2 → Fin n,
      ...
      intro Q2
      obtain ⟨g0eq, g1eq, g2eq, g3eq⟩ := cons_indices q0 q1 Q2
      rw [hχ_def]
      beta_reduce
  ...
  have hVsum : (∑ L : Fin 2 → Fin n, ∑ Q : Fin 4 → Fin n, (V Q) ^ 2 * χ Q L) =
    ...
    refine Finset.sum_congr rfl (fun Q _ => ?_)
    rw [← Finset.mul_sum]
    rw [show (∑ L : Fin 2 → Fin n, χ Q L) = 1 from pair_delta_sum_right (Q 2) (Q 3)]
    rw [mul_one]
  calc ∑ L : Fin 2 → Fin n,
        (∑ Q : Fin 4 → Fin n, V Q *
          fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
...
private def permutationOfImages {n : ℕ} (f g : Fin n → Fin n)
    (h₁ : Function.LeftInverse g f) (h₂ : Function.RightInverse g f) : Equiv.Perm (Fin n) :=
  ⟨f, g, h₁, h₂⟩

private def permutation4_0231 : Equiv.Perm (Fin 4) :=
  permutationOfImages ![0, 2, 3, 1] ![0, 3, 1, 2] (by decide) (by decide)

private def permutation4_0321 : Equiv.Perm (Fin 4) :=
  permutationOfImages ![0, 3, 2, 1] ![0, 3, 2, 1] (by decide) (by decide)

private def permutation4_2301 : Equiv.Perm (Fin 4) :=
  permutationOfImages ![2, 3, 0, 1] ![2, 3, 0, 1] (by decide) (by decide)

omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma ricciCometricFourTraceCLM_eq (g₁ : SmoothRiemannianMetric I M) (x : M) :
      ...
      ((1 : ℝ) / 2) •
        ((DeTurck.cometricDoubleTraceFib (I := I) g₁ 2 x).comp
            (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
              (I := I) permutation4_0231 x)
          + (DeTurck.cometricDoubleTraceFib (I := I) g₁ 2 x).comp
            (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
              (I := I) permutation4_0321 x)
          - DeTurck.cometricDoubleTraceFib (I := I) g₁ 2 x
          - (DeTurck.cometricDoubleTraceFib (I := I) g₁ 2 x).comp
            (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
              (I := I) permutation4_2301 x)) :=
  rfl

omit [FiniteDimensional ℝ E] [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless]
    [BoundarylessManifold I M] [T2Space M] [SigmaCompactSpace M] in
private lemma fiberNormSqComponent_half_combination (g : SmoothRiemannianMetric I M) (x : M)
    {n : ℕ} (e : Fin n → TangentSpace I x)
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma ricciCometricFourTrace_frame_operator_bound (g₀ g₁ : SmoothRiemannianMetric I M) (x : M)
    {n : ℕ} (e : Fin n → TangentSpace I x)
    (horth : ∀ a b : Fin n, g₀.inner x (e a) (e b) = if a = b then (1 : ℝ) else 0)
    (V : (Fin 4 → Fin n) → ℝ) :
    ∑ L : Fin 2 → Fin n,
  ...
  have hsingle : ∀ (ρ : Equiv.Perm (Fin 4)),
    ...
    have hreindex : ∀ L : Fin 2 → Fin n,
      ...
      rw [fiberNormSqComponent_comp_slotPermutation (I := I) (M := M) g₀ x e 4 2 T ρ Q L]
      rw [Equiv.symm_apply_apply]
      have hfun : (fun k => Q (ρ.symm k)) = ψ Q := by
        funext k
        rw [hψ_apply Q k]
      rw [hfun]
    have happ := singleTrace_functional_sq_le (I := I) (M := M) g₀ g₁ x e horth
      (fun Q' => V (ψ.symm Q'))
      ...
      (1 / 2 : ℝ) *
        ((∑ Q : Fin 4 → Fin n, V Q *
            fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
              (show TensorRSSpace 4 2 I x from
                T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                  (I := I) permutation4_0231 x)) n e Q L)
          + (∑ Q : Fin 4 → Fin n, V Q *
            fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
              (show TensorRSSpace 4 2 I x from
                T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                  (I := I) permutation4_0321 x)) n e Q L)
          - (∑ Q : Fin 4 → Fin n, V Q *
            fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
              (show TensorRSSpace 4 2 I x from
                T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                  (I := I) permutation4_2301 x)) n e Q L)
          - (∑ Q : Fin 4 → Fin n, V Q *
            fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
              (show TensorRSSpace 4 2 I x from T) n e Q L)) := by
    intro L
    have hpt : ∀ Q : Fin 4 → Fin n,
      ...
      rw [show fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
        ...
        exact congrArg (fun (S : TensorRSSpace 4 2 I x) =>
          ...
          (ricciCometricFourTraceCLM_eq (I := I) (M := M) g₁ x)]
      rw [fiberNormSqComponent_half_combination (I := I) (M := M) g₀ x e _ _ _ _ Q L]
      ring
  ...
  calc ∑ L : Fin 2 → Fin n,
      ...
      ≤ ∑ L : Fin 2 → Fin n,
          ((∑ Q : Fin 4 → Fin n, V Q *
              fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
                (show TensorRSSpace 4 2 I x from
                  T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                    (I := I) permutation4_0231 x)) n e Q L) ^ 2
            + (∑ Q : Fin 4 → Fin n, V Q *
              fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
                (show TensorRSSpace 4 2 I x from
                  T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                    (I := I) permutation4_0321 x)) n e Q L) ^ 2
            + (∑ Q : Fin 4 → Fin n, V Q *
              fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
                (show TensorRSSpace 4 2 I x from
                  T.comp (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.slotPermCLM
                    (I := I) permutation4_2301 x)) n e Q L) ^ 2
            + (∑ Q : Fin 4 → Fin n, V Q *
              fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
    ...
    _ ≤ HS * SV + HS * SV + HS * SV + HS * SV := by
        have h1 := hsingle permutation4_0231
        have h2 := hsingle permutation4_0321
        have h3 := hsingle permutation4_2301
        have h4 : ∑ L : Fin 2 → Fin n,
            (∑ Q : Fin 4 → Fin n, V Q *
              fiberNormSqComponent (I := I) (M := M) g₀ x 4 2
                (show TensorRSSpace 4 2 I x from T) n e Q L) ^ 2 ≤ HS * SV := by
          have happ := singleTrace_functional_sq_le (I := I) (M := M) g₀ g₁ x e horth V
          rw [← hT_def] at happ
          exact happ
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private lemma sum_sq_component_slotExtendIterFib_operator_le (g : SmoothRiemannianMetric I M)
      ...
      calc (∑ J : Fin (c + (w + 1)) → Fin n,
        ...
        _ ≤ ∑ j₀ : Fin n,
            ...
            Finset.sum_le_sum (fun j₀ _ =>
              sum_sq_component_slotExtendIterFib_operator_le g x e horth w b c A κ hA
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] in
private theorem riemannianFiberNormSq_comp_slotExtendIterFib_operator_le (g : SmoothRiemannianMetric I M) (x : M)
    {n : ℕ} (e : Fin n → TangentSpace I x)
    (bse : Module.Basis (Fin n) ℝ (TangentSpace I x))
  ...
  have hcomp : ∀ (K : Fin p → Fin n) (J : Fin (c + w) → Fin n),
      fiberNormSqComponent (I := I) (M := M) g x p (c + w)
          (show TensorRSSpace p (c + w) I x from
            (slotExtendIterFib (I := I) (M := M) g b c x A w).comp U) n e K J =
        ∑ P : Fin (b + w) → Fin n,
          fiberNormSqComponent (I := I) (M := M) g x p (b + w)
            (show TensorRSSpace p (b + w) I x from U) n e K P *
            fiberNormSqComponent (I := I) (M := M) g x (b + w) (c + w)
              (show TensorRSSpace (b + w) (c + w) I x from
                slotExtendIterFib (I := I) (M := M) g b c x A w) n e P J :=
    fun K J => fiberNormSqComponent_operatorFieldComposition_eq (I := I) (M := M) g p (b + w) (c + w) x
      (show TensorRSSpace (b + w) (c + w) I x from
  ...
  refine le_trans (Finset.sum_le_sum (fun K (_ : K ∈ Finset.univ) =>
    sum_sq_component_slotExtendIterFib_operator_le (I := I) (M := M) g x e horth w b c A κ hA
...
theorem riemannianFiberNormSq_operatorFieldComposition_ricciCometricFourTraceCastG0_corner_op_le (g₀ g₁ : SmoothRiemannianMetric I M)
  ...
  have hHS : (∑ a : Fin n, ∑ b : Fin n,
    ...
    have hcol : ∀ b : Fin n,
      ...
      intro b
      have hp := hpars (DifferentialGeometry.Analysis.Sobolev.TensorHilbert.metricComparisonEndomorphism
        (I := I) g₀ g₁ x (e b))
      rw [hp]
  ...
  have hA : ∀ V : (Fin 4 → Fin n) → ℝ,
      ∑ L : Fin 2 → Fin n,
        ...
        (4 * (Module.finrank ℝ E : ℝ) * (1 / (1 - δ₀)) ^ 2) *
          ∑ Q : Fin 4 → Fin n, (V Q) ^ 2 := by
    intro V
    have h := ricciCometricFourTrace_frame_operator_bound (I := I) (M := M) g₀ g₁ x e horth V
  ...
  rw [operatorFieldComposition_toSection (I := I) (M := M) g₀ 2 (4 + i) (2 + i)
    (operatorFieldApplicationLeibnizPsi (I := I) (M := M) g₀ 4 2
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ricciCometricFourTraceCastG0
        (I := I) g₀ g₁) i i) U x]
  rw [show (show Tensor0SSpace (4 + i) I x →L[ℝ] Tensor0SSpace (2 + i) I x from
      ...
      slotExtendIterFib (I := I) (M := M) g₀ 4 2 x
        (show Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x from
          (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ricciCometricFourTraceCastG0
            (I := I) g₀ g₁).toSection x) i from
    operatorFieldApplicationLeibnizPsi_diagonal_toSection (I := I) (M := M) g₀ 4 2
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ricciCometricFourTraceCastG0
        (I := I) g₀ g₁) i x]
  exact riemannianFiberNormSq_comp_slotExtendIterFib_operator_le (I := I) (M := M) g₀ x e bse hnE hbse horth
    i 2 4 2
    (show Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x from
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ricciCometricFourTraceCastG0
        (I := I) g₀ g₁).toSection x)
...
private theorem linearizedRicciConnectionDifferenceOrder0CoeffField_topOrderSeparated_bound (g₀ : SmoothRiemannianMetric I M) {δ₀ : ℝ}
  ...
  have hQq_nn : ∀ i, 0 ≤ Qq i := by
    intro i
    refine mul_nonneg (operatorFieldApplicationGdiag_nonneg (E := E) i) ?_
  ...
  have hClow_nn : ∀ i, 0 ≤ Clow i := by
    intro i
    refine mul_nonneg (mul_nonneg (Nat.cast_nonneg i) (operatorFieldApplicationGdiag_nonneg (E := E) i)) ?_
  ...
  have hAgrid : ∀ n : ℕ, n ≤ i →
    ...
    fun n hn => le_trans (hCA g₁ P htie hδ_le hδ0 hbound n x)
      (mul_le_mul_of_nonneg_left
        (le_of_eq (sum_antidiagonalTupleGrid_eq_boundedFactorGridWindow b (show n + 2 ≤ (i + 1) + 1 from by omega)))
        (hCA_nn n))
  have hcore : ∀ n, n ≤ i →
      riemannianFiberNormSq (I := I) (M := M) g₀ 3 (4 + n) x
        ((iteratedCovGrad (I := I) g₀ 3 4 n
    ...
    intro n hn
    refine le_trans (connectionDifferenceContravariantInsertionField_le (I := I) (M := M) g₀ g₁ n x) ?_
    rw [mul_assoc]
  ...
  have hWinner : ∀ m, m ≤ i →
      ...
      fr * CA m * Combinatorics.boundedFactorGridWindow b (i + 1) (m + 2) := by
    intro m hm
    refine le_trans (connectionDifferenceContrInsertionInnerField_le (I := I) (M := M) g₀ g₁ m x) ?_
    rw [mul_assoc]
  ...
  have hquad : ∀ W23 : SmoothCcTensor g₀ 2 3,
      ...
      Qq i * w :=
    fun W23 hW => operatorFieldComposition_capped_grid_bound (I := I) (M := M) g₀ b hb_nn
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
  ...
  have hWa : ∀ m, m ≤ i →
      ...
      fr * CA m * Combinatorics.boundedFactorGridWindow b (i + 1) (m + 2) := by
    intro m hm
    rw [operatorFieldComp23_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation102
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
        (I := I) g₀ g₁) m x]
    exact hWinner m hm
  have hWb : ∀ m, m ≤ i →
      ...
      fr * CA m * Combinatorics.boundedFactorGridWindow b (i + 1) (m + 2) := by
    intro m hm
    rw [operatorFieldComp23_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation120
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
        (I := I) g₀ g₁) m x]
    exact hWinner m hm
  have hrkval : riemannianFiberNormSq (I := I) (M := M) g₀ 1 (2 + (i + 1)) x
    ...
    refine le_trans
      ...
      (I := I) (M := M) g₀ P (i + 1) x) ?_
    exact DifferentialGeometry.Analysis.Spectral.riemannianFiberNormSq_iteratedCovGrad_ccTensor02Symm_le (I := I) (M := M) g₀ P (i + 2) x
    ...
    have hval : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
        ...
        (Real.sqrt fr) ^ 2 * riemannianFiberNormSq (I := I) (M := M) g₀ 1 (2 + (i + 1)) x
          ((iteratedCovGrad (I := I) g₀ 1 2 (i + 1)
            (connectionDifferenceSection (I := I) g₁ g₀)).toSection x) := by
      rw [Real.sq_sqrt hfr]
      exact connectionDifferenceGradContrInsertionField_le (I := I) (M := M) g₀ g₁ i x
    refine le_trans (sqrt_le_coeff_mul_sqrt hval (Real.sqrt_nonneg fr)) ?_
    exact mul_le_mul_of_nonneg_left hAsqrt (Real.sqrt_nonneg fr)
  have hjets : (iteratedCovGrad (I := I) g₀ 2 4 i
      (Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
        (I := I) g₀ g₁)).toSection x =
      (iteratedCovGrad (I := I) g₀ 2 4 i
        (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3201)
  ...
  have hq1 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
    ...
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3201
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁) (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation102)
  ...
  have hq2 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
    ...
    rw [riemannianFiberNormSq_iteratedCovGrad_reindexCoeffGen_eq (I := I) (M := M) g₀ 2 4
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        ...
        (I := I) g₀ g₁))))
        DifferentialGeometry.Analysis.Parabolic.TensorSpectral.innerContractionSwapPerm i x]
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation2301
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁) (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation102)
  ...
  have hq3 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
      ((iteratedCovGrad (I := I) g₀ 2 4 i
        ...
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
        (I := I) g₀ g₁))))).toSection x) ≤ Qq i * w := by
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3102
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁) (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation120)
  ...
  have hq4 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
    ...
    rw [riemannianFiberNormSq_iteratedCovGrad_reindexCoeffGen_eq (I := I) (M := M) g₀ 2 4
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        ...
        (I := I) g₀ g₁)))
        DifferentialGeometry.Analysis.Parabolic.TensorSpectral.innerContractionSwapPerm i x]
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation1302
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁)
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
  ...
  have hq5 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
      ((iteratedCovGrad (I := I) g₀ 2 4 i
        ...
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
        (I := I) g₀ g₁)))).toSection x) ≤ Qq i * w := by
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation1203
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁)
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContrInsertionInnerField
  ...
  have hq6 : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
    ...
    rw [riemannianFiberNormSq_iteratedCovGrad_reindexCoeffGen_eq (I := I) (M := M) g₀ 2 4
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        ...
        (I := I) g₀ g₁))))
        DifferentialGeometry.Analysis.Parabolic.TensorSpectral.innerContractionSwapPerm i x]
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation2103
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 4
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceContravariantInsertionField (I := I)
        g₀ g₁) (ccOperatorFieldComp (I := I) (M := M) g₀ 2 3 3
        (slotPermutationCc0 (I := I) (M := M) g₀ orderZeroKernelMiddlePermutation120)
  ...
  have hs7 : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
      ...
      Real.sqrt fr * (d * Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 0 (2 + (i + 2)) x
        ((iteratedCovGrad (I := I) g₀ 0 2 (i + 2) P).toSection x))
        + Real.sqrt ((Kc (i + 1) * ((i : ℝ) + 1)) * w)) := by
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation3012
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceGradContrInsertionField
        (I := I) g₀ g₁) i x]
    exact hgrad_sqrt
  have hs8 : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
    ...
    rw [riemannianFiberNormSq_iteratedCovGrad_reindexCoeffGen_eq (I := I) (M := M) g₀ 2 4
      (ccOperatorFieldComp (I := I) (M := M) g₀ 2 4 4
        ...
        (I := I) g₀ g₁))
        DifferentialGeometry.Analysis.Parabolic.TensorSpectral.innerContractionSwapPerm i x]
    rw [operatorFieldComp24_riemannianFiberNormSq_eq (I := I) (M := M) g₀ orderZeroKernelOutputPermutation2013
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.connectionDifferenceGradContrInsertionField
        (I := I) g₀ g₁) i x]
    exact hgrad_sqrt
  have hWK_sqrt : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + i) x
      ...
      + 2 * (Real.sqrt fr * (d * Real.sqrt
        ...
        + Real.sqrt ((Kc (i + 1) * ((i : ℝ) + 1)) * w))) := by
    rw [hjets]
    refine le_trans (sqrt_riemannianFiberNormSq_six_add_two_sub_le (I := I) (M := M) g₀ 2 (4 + i) x _ _ _ _ _ _ _ _) ?_
    have t1 := Real.sqrt_le_sqrt hq1
    have t2 := Real.sqrt_le_sqrt hq2
    have t3 := Real.sqrt_le_sqrt hq3
    have t4 := Real.sqrt_le_sqrt hq4
    have t5 := Real.sqrt_le_sqrt hq5
    have t6 := Real.sqrt_le_sqrt hq6
  ...
  have hcval : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
    ...
    exact riemannianFiberNormSq_operatorFieldComposition_ricciCometricFourTraceCastG0_corner_op_le (I := I) (M := M) g₀ g₁ P htie hδ₀
      hδ_le hδ0 hbound i
      (iteratedCovGrad (I := I) g₀ 2 4 i
        (Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
        (I := I) g₀ g₁)) x
  have hlow : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
    ...
    refine le_trans (riemannianFiberNormSq_operatorFieldComposition_argLower_le (I := I) (M := M) g₀ 2 4 2
    ...
    have hcell : ∀ k ∈ Finset.range i,
      ...
      have h4 : riemannianFiberNormSq (I := I) (M := M) g₀ 4 (2 + (i - k)) x
        ...
        le_trans (hC4 g₁ P htie hδ_le hδ0 hbound (i - k) x)
          (mul_le_mul_of_nonneg_left
            (le_of_eq (sum_antidiagonalTupleGrid_eq_boundedFactorGridWindow b (show (i - k) + 1 ≤ (i + 1) + 1 from by omega)))
            (hC4_nn (i - k)))
      have hKk : riemannianFiberNormSq (I := I) (M := M) g₀ 2 (4 + k) x
        ...
        le_trans (hCK g₁ P htie hδ_le hδ0 hbound k x)
          (mul_le_mul_of_nonneg_left
            (le_of_eq (sum_antidiagonalTupleGrid_eq_boundedFactorGridWindow b (show k + 3 ≤ (i + 1) + 1 from by omega)))
            (hCK_nn k))
    ...
    calc (i : ℝ) * diagonalGridGrowthFactor (E := E) i *
        ...
        ≤ (i : ℝ) * diagonalGridGrowthFactor (E := E) i *
          ...
          mul_le_mul_of_nonneg_left (Finset.sum_le_sum hcell)
            (mul_nonneg (Nat.cast_nonneg i) (operatorFieldApplicationGdiag_nonneg (E := E) i))
      _ = Clow i * w := by
          simp only [hClow_def]
          rw [← Finset.sum_mul]
          ring
          ...
          ccOperatorFieldComp (I := I) (M := M) g₀ 2 (4 + k) (2 + i)
            ...
            (iteratedCovGrad (I := I) g₀ 2 4 k
              (Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
                (I := I) g₀ g₁))).toSection x := by
    rw
      [linearizedRicciConnectionDifferenceOrder0CoeffField_eq_ricciCometricFourTrace_comp_kernelField
      (I := I) (M := M) g₀ g₁,
      iteratedCovGrad_operatorFieldComposition_eq_argCorner_add_lower (I := I) (M := M) g₀ 2 4 2
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ricciCometricFourTraceCastG0
          (I := I) g₀ g₁)
        (Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
          (I := I) g₀ g₁) i,
  ...
  have hfold1 : (12 * Real.sqrt fr * d) * Real.sqrt (Qq i * w) =
    ...
    rw [coeff_mul_sqrt_eq_sqrt_sq_mul (show (0 : ℝ) ≤ 12 * Real.sqrt fr * d from by positivity),
  ...
  have hfold2 : (4 * fr * d) * Real.sqrt ((Kc (i + 1) * ((i : ℝ) + 1)) * w) =
    ...
    rw [coeff_mul_sqrt_eq_sqrt_sq_mul (show (0 : ℝ) ≤ 4 * fr * d from by positivity),
  ...
  have htot : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
    ...
    have hcs : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
      ...
      le_trans (sqrt_le_coeff_mul_sqrt hcval (by positivity))
    ...
    have hls : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
        ((∑ k ∈ Finset.range i,
          ccOperatorFieldComp (I := I) (M := M) g₀ 2 (4 + k) (2 + i)
            ...
            (iteratedCovGrad (I := I) g₀ 2 4 k
              (Analysis.Parabolic.TensorSpectral.linearizedRicciConnectionDifferenceOrder0KernelField
                (I := I) g₀ g₁))).toSection x)) ≤ Real.sqrt (Clow i * w) := Real.sqrt_le_sqrt hlow
  ...
  have hfin := three_remainder_young_bound
...
private lemma one_remainder_young_bound {T e btop c K w : ℝ}
  ...
  have hTuv : T ≤ (u + v) ^ 2 := by
    ...
    rw [Real.sq_sqrt hT0] at hsq
    exact hsq
  have hyoung := DifferentialGeometry.Analysis.add_sq_le_young u v (1 / 4) (by norm_num)
  have hu2 : u ^ 2 = e ^ 2 * btop := by
    rw [hu_def, mul_pow, Real.sq_sqrt hbtop]
        ...
        (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
            ((ccOperatorFieldComp (I := I) (M := M) g₀ 2 (6 + i) (2 + i)
              (operatorFieldApplicationLeibnizPsi (I := I) (M := M) g₀ 6 2
                (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.secondMetricPairTraceOperator
                  (I := I) (M := M) g₀ g₁) i i)
...
theorem decompositionKernelContractionMonomialField_eq_of_finrank_one (h1 : Module.finrank ℝ E = 1)
    ...
    DifferentialGeometry.Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
      (I := I) (M := M) g₀ g₁ G σ =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
        (I := I) (M := M) g₀ g₁ G σ' := by
  classical
  ...
  intro x
  rw
    [Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField_toSection
    (I := I) (M := M) g₀ g₁ G σ x,
    Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField_toSection
      (I := I) (M := M) g₀ g₁ G σ' x]
  ...
  rw [show
    Analysis.Parabolic.TensorSpectral.curvatureDecompositionMonomialOrthonormalFrameBiContraction
    (I := I) (M := M) g₁
      (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ccTensorRank4EvalAtUnitZeroSec
        (I := I) (M := M) g₀ G) σ x =
      DifferentialGeometry.Analysis.Parabolic.TensorSpectral.curvatureDecompositionMonomialFrameContraction
        (I := I) (M := M)
        (DifferentialGeometry.Analysis.Parabolic.TensorSpectral.ccTensorRank4EvalAtUnitZeroSec
          (I := I) (M := M) g₀ G) σ
  ...
  intro v
  rw
    [Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialFibFixedFrame_toModel,
    Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialFibFixedFrame_toModel]
...
private theorem decompositionKernelContractionField_topOrderSeparated_bound (g₀ : SmoothRiemannianMetric I M) {δ₀ : ℝ}
    (hδ₀ : δ₀ < 1) (_hδ₀half : δ₀ ≤ 1 / 2) :
    ∃ K : ℕ → ℝ, (∀ i, 0 ≤ K i) ∧
      ∀ (g₁ : SmoothRiemannianMetric I M) (P : SmoothCcTensor g₀ 0 2)
        (_htie : ∀ (y : M) (v w : TangentSpace I y),
  ...
  · refine ⟨fun _ => 0, fun _ => le_refl 0, ?_⟩
    intro g₁ P htie δ hδ_le hδ0 hbound i x
    have hzero : DifferentialGeometry.Analysis.Parabolic.TensorSpectral.decompositionKernelContractionField
        (I := I) (M := M) g₀ g₁
        (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
        (Equiv.swap (0 : Fin 4) 2) (Equiv.swap (1 : Fin 4) 3)
        (Equiv.swap (0 : Fin 4) 2 * Equiv.swap (1 : Fin 4) 3) 1 = 0 := by
      rw [show DifferentialGeometry.Analysis.Parabolic.TensorSpectral.decompositionKernelContractionField
          (I := I) (M := M) g₀ g₁
          (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
          (Equiv.swap (0 : Fin 4) 2) (Equiv.swap (1 : Fin 4) 3)
            ...
            (Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
              ...
              - Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
                ...
                (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P)) 1) from
                  rfl]
      rw [decompositionKernelContractionMonomialField_eq_of_finrank_one (I := I) (M := M) hn1 g₀ g₁
          (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
            (Equiv.swap (1 : Fin 4) 3) (Equiv.swap (0 : Fin 4) 2),
        decompositionKernelContractionMonomialField_eq_of_finrank_one (I := I) (M := M) hn1 g₀ g₁
          (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
      ...
      rw [smul_zero]
    rw [hzero, DifferentialGeometry.Analysis.Sobolev.iteratedCovGrad_zero_section (I := I) g₀ 2 2 i,
      DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_zero_apply (I := I) g₀
        (r := 2) (s := 2 + i) x,
  ...
  · have hn2 : 2 ≤ Module.finrank ℝ E := by
    ...
    have hsm : ∀ σ : Equiv.Perm (Fin 4),
      ...
      have h1 := Real.sqrt_le_sqrt hconj.1
      have h2 := Real.sqrt_le_sqrt hconj.2
    ...
    have hsplit : (iteratedCovGrad (I := I) g₀ 2 2 i
          ...
          (1 / 2 : ℝ) •
            (Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
              ...
              - Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
                ...
                (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P)) 1) from
                  rfl]
      rw [DifferentialGeometry.Analysis.Spectral.iteratedCovGrad_smul (I := I) (M := M) g₀ 2 2 i]
      ...
      rw [DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_sub_apply (I := I) (M := M) g₀
          (r := 2) (s := 2 + i),
        DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_sub_apply (I := I) (M := M) g₀
          (r := 2) (s := 2 + i),
        DifferentialGeometry.Analysis.Sobolev.smoothCcTensor_toSection_add_apply (I := I) (M := M) g₀
          (r := 2) (s := 2 + i)]
    have htot : Real.sqrt (riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
      ...
      have hsub2 := sqrt_riemannianFiberNormSq_sub_le (I := I) (M := M) g₀ 2 (2 + i) x
        ...
        ((iteratedCovGrad (I := I) g₀ 2 2 i
          (Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
            ...
            (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
              1)).toSection x)
      have hsub1 := sqrt_riemannianFiberNormSq_sub_le (I := I) (M := M) g₀ 2 (2 + i) x
        ((iteratedCovGrad (I := I) g₀ 2 2 i
          (Analysis.Parabolic.TensorSpectral.decompositionKernelContractionMonomialField
            (I := I) (M := M) g₀ g₁
            (iteratedCovGrad (I := I) g₀ 0 2 2 (ccTensor02Symm (I := I) (M := M) g₀ P))
    ...
    have hfin := one_remainder_young_bound (hb_nn (i + 2)) hw_nn
        ...
        riemannianFiberNormSq (I := I) (M := M) g₀ 2 (2 + i) x
          ...
          ((21 / 4 : ℝ) * (Module.finrank ℝ E : ℝ) * (1 / (1 - δ₀)) ^ 2) ^ 2 *
            ...
            + K i * Combinatorics.boundedFactorGridWindow
                (fun l => riemannianFiberNormSq (I := I) (M := M) g₀ 0 (2 + l) x
                  ((iteratedCovGrad (I := I) g₀ 0 2 l P).toSection x)) (i + 1) (i + 3) :=
  linearizedRicciConnectionDifferenceOrder0CoeffField_topOrderSeparated_bound (I := I) (M := M) g₀ hδ₀ hδ₀half
