...
theorem mixed_background_connection_block_normal_form {n : ℕ} (ig cg f : Fin n → Fin n → ℝ)
    (ga0 ga1 gbg : Fin n → Fin n → Fin n → ℝ)
    (higs : ∀ a b, ig a b = ig b a) (hcgs : ∀ a b, cg a b = cg b a)
    (hga1s : ∀ a b k, ga1 a b k = ga1 b a k)
    (hgbgs : ∀ a b k, gbg a b k = gbg b a k) (i j : Fin n) :
    mixedBackgroundHalfBlock ig cg ga1 ga0 gbg f i j =
      (-(∑ a, ∑ b, ∑ c, ∑ d, ∑ e, ∑ r,
  ...
  have h1 : mixedBackgroundHalfBlock ig cg ga1 ga0 gbg f i j =
      (∑ b0, ∑ b1, ∑ b2, ∑ b3, ∑ b4, ∑ b5,
    ...
    simp only [mixedBackgroundHalfBlock]
...
theorem mixed_background_connection_block_normal_form_swap {n : ℕ} (ig cg f : Fin n → Fin n → ℝ)
    (ga0 ga1 gbg : Fin n → Fin n → Fin n → ℝ)
    (higs : ∀ a b, ig a b = ig b a) (hcgs : ∀ a b, cg a b = cg b a)
    (hga1s : ∀ a b k, ga1 a b k = ga1 b a k)
    (hgbgs : ∀ a b k, gbg a b k = gbg b a k) (i j : Fin n) :
    mixedBackgroundHalfBlock ig cg ga1 ga0 gbg f j i =
      (-(∑ a, ∑ b, ∑ c, ∑ d, ∑ e, ∑ r,
  ...
  mixed_background_connection_block_normal_form ig cg f ga0 ga1 gbg higs hcgs hga1s hgbgs j i
