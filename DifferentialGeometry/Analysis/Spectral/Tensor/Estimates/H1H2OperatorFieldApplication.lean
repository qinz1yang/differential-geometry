...
theorem operator_field_application_h1_h2_to_h1_bound
  ...
  have hY0 : ‖Y‖ ≤ Cpt * A * N := by
    have h0 := operatorFieldApplication_l2_right
      (I := I) (M := M) g r c Φ U
  ...
  have hcross :
    ...
    have hc := operatorFieldApplication_l2_right
      (I := I) (M := M) g r (c + 1)
  ...
  have hslot :
    ...
    have hp := operatorFieldApplication_l6_l3_l2 (I := I) (M := M) g (r + 1) (c + 1)
