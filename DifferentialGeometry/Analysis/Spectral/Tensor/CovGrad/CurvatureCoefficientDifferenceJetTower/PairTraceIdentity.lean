...
private lemma operatorFieldComposition_zero_left_cc (g₀ : SmoothRiemannianMetric I M) (a b c : ℕ)
...
omit [NeZero (Module.finrank ℝ E)] [I.Boundaryless] [BoundarylessManifold I M]
    [SigmaCompactSpace M] in
private lemma operatorFieldComposition_right_zero_cc (g₀ : SmoothRiemannianMetric I M) (a b c : ℕ)
