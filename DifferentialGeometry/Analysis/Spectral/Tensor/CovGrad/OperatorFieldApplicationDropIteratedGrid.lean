...
private theorem riemannianFiberNormSq_iteratedCovGrad_covGrad_comm_drop (g : SmoothRiemannianMetric I M)
...
omit [BoundarylessManifold I M] [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem riemannianFiberNormSq_iteratedCovGrad_covGrad_comm (g : SmoothRiemannianMetric I M)
    (s m : ℕ) (W : SmoothCcTensor g 0 s) (x : M) :
    riemannianFiberNormSq (I := I) (M := M) g 0 ((s + 1) + m) x
        ((iteratedCovGrad g 0 (s + 1) m (covGrad g 0 s W)).toSection x) =
      riemannianFiberNormSq (I := I) (M := M) g 0 (s + (m + 1)) x
        ((iteratedCovGrad g 0 s (m + 1) W).toSection x) :=
  riemannianFiberNormSq_iteratedCovGrad_covGrad_comm_drop g s m W x
...
def operatorFieldApplicationLeibnizTower (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ) (C : SmoothCcTensor g b₀ s₀) :
  ...
  | (p + 1), w => fun W =>
      covGrad (I := I) (M := M) g 0 ((s₀ + w) + p)
          (operatorFieldApplicationLeibnizTower g b₀ s₀ C p w W) -
        castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
          (operatorFieldApplicationLeibnizTower g b₀ s₀ C p (w + 1) (covGrad (I := I) (M := M) g 0 (b₀ + w) W))
...
theorem DropTower_covGrad_op (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
    ...
    covGrad (I := I) (M := M) g 0 ((s₀ + w) + p)
        (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p w W) =
      operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C (p + 1) w W +
        castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
          (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p (w + 1)
...
theorem covGrad_dropNormalForm_sum (g : SmoothRiemannianMetric I M) (b₀ s₀ p w : ℕ)
  ...
  rw [covGrad_operatorFieldComposition_eq (I := I) (M := M) g 0 ((b₀ + w) + k) ((s₀ + w) + p) (Ψ k)
    (iteratedCovGrad g 0 (b₀ + w) k W)]
...
omit [BoundarylessManifold I M] [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem castRankCc_operatorFieldComposition_drop_iteratedCovGrad_covGrad (g : SmoothRiemannianMetric I M)
    (b₀ s₀ p w k : ℕ)
    ...
    castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
      ...
      ccOperatorFieldComp (I := I) (M := M) g 0 ((b₀ + w) + (k + 1)) ((s₀ + w) + (p + 1))
        ...
        (iteratedCovGrad g 0 (b₀ + w) (k + 1) W) := by
  rw [operatorFieldComposition_castCcTensorRank g 0 (by omega : (b₀ + (w + 1)) + k = (b₀ + w) + (k + 1))
    (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1)) Ψ
    (iteratedCovGrad g 0 (b₀ + (w + 1)) k (covGrad g 0 (b₀ + w) W))]
  congr 1
  apply eq_of_heq
...
theorem dropNormalForm_succ (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  refine ⟨fun j => match j with
    ...
    | (k + 1) =>
        (if k + 1 < p + 1 then
          ...
          + Tk k, ?_⟩
  intro W
  have hrec : operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C (p + 1) w W =
      covGrad g 0 ((s₀ + w) + p) (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p w W) -
        castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
          (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p (w + 1)
            (covGrad (I := I) (M := M) g 0 (b₀ + w) W)) := by
  ...
  rw [hΨr1 (covGrad g 0 (b₀ + w) W), castCcTensorRank_finset_sum]
  rw [show (∑ k ∈ Finset.range (p + 1),
    ...
    Finset.sum_congr rfl (fun k _ =>
      castRankCc_operatorFieldComposition_drop_iteratedCovGrad_covGrad (I := I) (M := M) g b₀ s₀ p w k (Ψr1 k) W)]
...
theorem dropTowerPsi_spec (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  | succ p ih =>
      ...
      rw [ih (w + 1) (covGrad g 0 (b₀ + w) W), castCcTensorRank_finset_sum]
      rw [show (∑ k ∈ Finset.range (p + 1),
            castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
              (ccOperatorFieldComp (I := I) (M := M) g 0 ((b₀ + (w + 1)) + k) ((s₀ + (w + 1)) + p)
          ...
          ∑ k ∈ Finset.range (p + 1),
            ccOperatorFieldComp (I := I) (M := M) g 0 ((b₀ + w) + (k + 1)) ((s₀ + w) + (p + 1))
              ...
              (iteratedCovGrad g 0 (b₀ + w) (k + 1) W) from
        Finset.sum_congr rfl (fun k _ =>
          castRankCc_operatorFieldComposition_drop_iteratedCovGrad_covGrad (I := I) (M := M) g b₀ s₀ p w k
      ...
      have hsplit : (∑ k ∈ Finset.range (p + 1),
        ...
        refine Finset.sum_congr rfl (fun k _ => ?_)
        rw [hPsiSucc k, operatorFieldComposition_add_left, operatorFieldComposition_sub_left]
      rw [hsplit]
      rw [show (∑ k ∈ Finset.range (p + 1),
            ccOperatorFieldComp (I := I) (M := M) g 0 ((b₀ + w) + (k + 1)) ((s₀ + w) + (p + 1))
              (if k + 1 < p + 1 then
...
theorem dropFibreSup_spec (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  rw [operatorFieldComposition_toSection (I := I) (M := M) g 0 ((b₀ + w) + k) ((s₀ + w) + p)
...
omit [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem dropTower_riemannianFiberNormSq_op_le (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
    (C : SmoothCcTensor g b₀ s₀) (p w : ℕ) (W : SmoothCcTensor g 0 (b₀ + w)) (x : M) :
    riemannianFiberNormSq (I := I) (M := M) g 0 ((s₀ + w) + p) x
        ((operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p w W).toSection x) ≤
...
theorem exists_dropTower_jet_bound (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  ⟨dropKappa (I := I) (M := M) g b₀ s₀ C p w, dropKappa_nonneg (I := I) (M := M) g b₀ s₀ C p w,
    fun W x => dropTower_riemannianFiberNormSq_op_le (I := I) (M := M) g b₀ s₀ C p w W x⟩

omit [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem dropTower_riemannianFiberNormSq_iteratedCovGrad_grid (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  | zero =>
      ...
      exact dropTower_riemannianFiberNormSq_op_le (I := I) (M := M) g b₀ s₀ C p w W x
  | succ j ih =>
      intro p w W x
      ...
      rw [show riemannianFiberNormSq (I := I) (M := M) g 0 (((s₀ + w) + p) + (j + 1)) x
          ...
          riemannianFiberNormSq (I := I) (M := M) g 0 ((((s₀ + w) + p) + 1) + j) x
            ((iteratedCovGrad g 0 (((s₀ + w) + p) + 1) j
              (covGrad g 0 ((s₀ + w) + p)
                (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p w W))).toSection x) from
        (riemannianFiberNormSq_iteratedCovGrad_covGrad_comm_drop g ((s₀ + w) + p) j
          (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p w W) x).symm]
      ...
      refine (riemannianFiberNormSq_add_le (I := I) (M := M) g 0 ((((s₀ + w) + p) + 1) + j) x
          ((iteratedCovGrad g 0 (((s₀ + w) + p) + 1) j
            (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C (p + 1) w W)).toSection x)
          ((iteratedCovGrad g 0 (((s₀ + w) + p) + 1) j
            (castCcTensorRank g 0 (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
              (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p (w + 1)
      ...
      have hBshift : gridWindowSum (dropKappa (I := I) (M := M) g b₀ s₀ C) p (w + 1) j *
        ...
        exact Finset.sum_congr rfl fun q _ =>
          riemannianFiberNormSq_iteratedCovGrad_covGrad_comm_drop g (b₀ + w) q W x
      ...
      have hb_eq : riemannianFiberNormSq (I := I) (M := M) g 0 ((((s₀ + w) + p) + 1) + j) x
        ...
        riemannianFiberNormSq_iteratedCovGrad_castCcTensorRank g 0
          (by omega : (s₀ + (w + 1)) + p = (s₀ + w) + (p + 1))
          (operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C p (w + 1) (covGrad g 0 (b₀ + w) W)) j x
      rw [hb_eq]
...
omit [BoundarylessManifold I M] [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem dropTowerOp_zero_eq_operatorFieldApply (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
    (C : SmoothCcTensor g b₀ s₀) (W : SmoothCcTensor g 0 b₀) :
    operatorFieldApplicationLeibnizTower (I := I) (M := M) g b₀ s₀ C 0 0 W = operatorFieldApply (I := I) (M := M) g b₀
      s₀ C W := by
...
omit [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem operatorFieldApplication_iteratedCovGrad_drop_singleSum_le_explicit (g : SmoothRiemannianMetric I M)
    (b₀ s₀ : ℕ)
  ...
  have hgrid := dropTower_riemannianFiberNormSq_iteratedCovGrad_grid (I := I) (M := M) g b₀ s₀ C j 0 0 W x
  rw [dropTowerOp_zero_eq_operatorFieldApply (I := I) (M := M) g b₀ s₀ C W] at hgrid
  simpa only [Nat.add_zero, Nat.zero_add, mul_assoc] using hgrid

omit [CompleteSpace E] in
omit [NeZero (Module.finrank ℝ E)] in
theorem operatorFieldApplication_iteratedCovGrad_drop_singleSum_le (g : SmoothRiemannianMetric I M) (b₀ s₀ : ℕ)
  ...
  ⟨fun j => (4 : ℝ) ^ j * gridWindowSum (dropKappa (I := I) (M := M) g b₀ s₀ C) 0 0 j,
    ...
    fun W j x => operatorFieldApplication_iteratedCovGrad_drop_singleSum_le_explicit (I := I) (M := M) g b₀ s₀ C W j x⟩
