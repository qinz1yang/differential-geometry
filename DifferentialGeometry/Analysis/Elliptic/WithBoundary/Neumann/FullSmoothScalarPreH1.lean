...
lemma FullSmoothScalar.continuous_inner_grad [SigmaCompactSpace M]
...
def fullSmoothScalarH1Inner [SigmaCompactSpace M]
...
lemma fullSmoothScalarH1Inner_def [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M} (f h : FullSmoothScalar g) :
...
lemma fullSmoothScalarH1Inner_symm [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M} (f h : FullSmoothScalar g) :
...
lemma FullSmoothScalar.integral_mul_self_nonneg [SigmaCompactSpace M]
...
lemma FullSmoothScalar.integral_inner_grad_self_nonneg [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M} (f : FullSmoothScalar g) :
...
lemma fullSmoothScalarH1Inner_nonneg [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M} (f : FullSmoothScalar g) :
...
lemma fullSmoothScalar_integral_mul_smul_left [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M}
...
lemma fullSmoothScalar_integral_inner_grad_smul_left [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M}
    (c : ℝ) (f h : FullSmoothScalar g) :
...
lemma fullSmoothScalarH1Inner_smul_left [SigmaCompactSpace M]
    {g : SmoothRiemannianMetric (I_half n) M}
    (c : ℝ) (f h : FullSmoothScalar g) :
