...
omit [CompactSpace M] [I.Boundaryless] in
omit [SigmaCompactSpace M] in
theorem ricciContractionBiContrFib_eq_fixedFrame_on_neighborhood (g₀ g₁ : SmoothRiemannianMetric I M)
...
theorem ricciContractionBiContrFib_contMDiff (g₀ g₁ : SmoothRiemannianMetric I M)
  ...
  exact congrArg (TotalSpace.mk' (TensorRSModel 2 2 ℝ E)
    ...
    (congrArg TensorRSSpace.ofCLM
      (ricciContractionBiContrFib_eq_fixedFrame_on_neighborhood (I := I) g₀ g₁ S x₀ hy))
