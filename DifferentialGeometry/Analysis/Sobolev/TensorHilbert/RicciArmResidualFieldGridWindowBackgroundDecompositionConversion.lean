...
import DifferentialGeometry.Analysis.Sobolev.TensorHilbert.RicciArmResidualFieldGridWindowBackgroundDecompositionConversionFrameModelMultilinearIdentities
import DifferentialGeometry.Analysis.Sobolev.TensorHilbert.RicciArmResidualFieldGridWindowBackgroundDecompositionConversionFiberNormPointwiseBounds
import DifferentialGeometry.Analysis.Sobolev.TensorHilbert.RicciArmResidualFieldGridWindowBackgroundDecompositionConversionDoubleTraceFullRaisedFold
...
lemma sharpGradKoszulResidualField_eq_decomposition (P : SmoothCcTensor g₀ 0 2)
  ...
  rw [show unitModel (I := I) (M := M) g₀ 4
      ...
      sharpGradKoszulKernelBilin (I := I) g₀ g₁ (ccTensor02Symm (I := I) g₀ P) x
        (smoothOrthoFrame (I := I) g₁ x a x) (smoothOrthoFrame (I := I) g₁ x b x)
        (v 0) (v 1) from
    sharpGradKoszulKernel_foldWeights_unitModel (I := I) (M := M) g₀ g₁ P htie x
      (smoothOrthoFrame (I := I) g₁ x a x) (smoothOrthoFrame (I := I) g₁ x b x)
      (v 0) (v 1)]
