...
theorem cmChartFDerivLe
  ...
  exact norm_fderiv_implicit_le (fun z params => chartCmEqn' (I := I) g hEnorm p z params) z₀ params₀
...
theorem cmChartDerivLe2
  ...
  · have hf_ev : ∀ᶠ q in nhds params₀,
    ...
    have hDf_le : ‖Df‖ ≤ hbd.Λ * B 1 :=
      norm_fderiv_implicit_le (fun z params => chartCmEqn' (I := I) g hEnorm p z params) z₀ params₀
