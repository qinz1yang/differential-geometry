import DifferentialGeometry.Geometry.Compactness.CheegerGromov.ApproximateIsometry.MetricApproximationBoundsCompositionReverse
...
noncomputable def sepData_comp [I.Boundaryless] {P : Type u} [TopologicalSpace P] [ChartedSpace H P] [IsManifold I ∞ P]
