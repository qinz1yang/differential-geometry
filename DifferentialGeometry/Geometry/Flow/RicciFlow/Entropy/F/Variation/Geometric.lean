...
theorem fFunctionalFirstVariationFormula_of_connection_trace_field
    ...
    FFunctionalFirstVariationFormula
      ...
      potentialVariation metricVariationTrace metricVariationRicciHess :=
  fFunctionalFirstVariationFormula_of_trace_vector (I := I) g hpotential hq
...
omit [NeZero (Module.finrank ℝ E)] in
theorem fFunctionalFirstVariationFormula_of_connection_trace_components
    [I.Boundaryless] [T2Space M] [CompactSpace M]
    (g : SmoothRiemannianMetric I M)
    (A : Tensor0SBundle.TensorRSField (𝕜 := Real) (E := E) (H := H)
      (I := I) (M := M) (n := (∞ : WithTop ℕ∞)) 1 2)
  ...
  exact fFunctionalFirstVariationFormula_of_connection_trace_field (I := I) g A hpotential hq hmeas
...
omit [NeZero (Module.finrank ℝ E)] in
theorem fFunctionalFirstVariationFormula_of_christoffel_variation_components
    [I.Boundaryless] [T2Space M] [CompactSpace M]
    (g : SmoothRiemannianMetric I M)
    (A : Tensor0SBundle.TensorRSField (𝕜 := Real) (E := E) (H := H)
      (I := I) (M := M) (n := (∞ : WithTop ℕ∞)) 1 2)
...
omit [NeZero (Module.finrank ℝ E)] in
theorem fFunctionalFirstVariationFormula_of_metric_connection_family
    [I.Boundaryless] [T2Space M] [CompactSpace M]
