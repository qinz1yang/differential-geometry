...
fields here; no field accepts the desired compactness conclusion itself.
-/
...
comparison maps, scalar convergence, and window-uniform metric convergence in
its `FlowLimitData` field. -/
