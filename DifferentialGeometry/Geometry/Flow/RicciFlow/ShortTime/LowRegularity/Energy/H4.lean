...
theorem lowerScaleActions_covariantDerivative_three_tame_bound (hDim : Module.finrank ℝ E = 3)
...
theorem exists_galerkin_action_h3_tame_bound_constants (hDim : Module.finrank ℝ E = 3)
    (g₀ : SmoothRiemannianMetric I M) :
    ∃ Ctop Kr2 Kr1 Kcap : ℝ,
...
private theorem exists_galerkin_energy_four_bound_of_three_bound_parameters_raw (hDim : Module.finrank ℝ E = 3)
  ...
  obtain ⟨Ctop₃, Kr2, Kr1, Kcap, hCtop₃, hKr2, hKr1, hKcap, hord⟩ :=
    exists_galerkin_action_h3_tame_bound_constants (I := I) (M := M) hDim g₀
...
def HasGalerkinEnergyFourBound (g₀ : SmoothRiemannianMetric I M)
...
theorem exists_galerkin_energy_four_bound_parameters (hDim : Module.finrank ℝ E = 3)
    (g₀ : SmoothRiemannianMetric I M) :
    ∃ Ctop₃ Kr2 Kr1 Kcap : ℝ,
