...
theorem galerkin_background_action_sobolev_three_pairing_bound_for_smaller_metric_perturbations
...
theorem galerkin_background_action_sobolev_three_pairing_bound
    (hDim : Module.finrank ℝ E = 3)
    (gBase : SmoothRiemannianMetric I M)
    {Λ : ℝ} (hΛ : 1 ≤ Λ) :
    ∀ {eta : ℝ}, 0 < eta →
  ...
  obtain ⟨delta, hdelta, hdeltathird, hpair⟩ :=
    galerkin_background_action_sobolev_three_pairing_bound_for_smaller_metric_perturbations (I := I) (M := M) hDim gBase hΛ heta
  obtain ⟨R0, hR0, hR0one, hpair0⟩ := hpair hdelta le_rfl
  exact ⟨delta, R0, hdelta, hdeltathird, hR0, hR0one, hpair0⟩

theorem galerkin_background_action_sobolev_three_pairing_bound_of_low_view_norm_le_for_smaller_metric_perturbations
    (hDim : Module.finrank ℝ E = 3)
    (gBase : SmoothRiemannianMetric I M)
    {Λ : ℝ} (hΛ : 1 ≤ Λ) :
    ∀ {eta : ℝ}, 0 < eta →
...
theorem galerkin_background_action_sobolev_three_pairing_bound_of_low_view_norm_le
    (hDim : Module.finrank ℝ E = 3)
    (gBase : SmoothRiemannianMetric I M)
    {Λ : ℝ} (hΛ : 1 ≤ Λ) :
    ∀ {eta : ℝ}, 0 < eta →
  ...
  intro eta heta
  obtain ⟨delta, hdelta, hdeltathird, hpair⟩ :=
    galerkin_background_action_sobolev_three_pairing_bound_of_low_view_norm_le_for_smaller_metric_perturbations (I := I) (M := M) hDim gBase hΛ heta
  obtain ⟨R0, hR0, hR0one, hpair0⟩ := hpair hdelta le_rfl
  exact ⟨delta, R0, hdelta, hdeltathird, hR0, hR0one, hpair0⟩
