...
import DifferentialGeometry.Analysis.Spectral.Intrinsic.DeTurck.DeTurckRemainderPrincipalArm.OperatorNorm
...
theorem rem_h1_of_bounds
    ...
    ∃ ρ Ctop Clow Ccoef : ℝ,
      ...
      ∀ (T T' : SmoothCcTensor g₀ 0 2)
        ...
        ‖ccTensorToHs (I := I) (M := M) g₀ 2 (1 : ℝ)
          ((deTurckRHSAtMetricPerturbation (I := I) g₀ g_bg T
                hδ_lt hδ -
              deTurckRHSAtMetricPerturbation (I := I) g₀ g_bg T'
                hδ'_lt hδ') -
  ...
  let Φ₀ : SmoothCcTensor g₀ 2 2 :=
    ricciDeTurckRemainderZeroOrderPathIntegral (I := I) (M := M) g₀ g_bg T T' hδ_lt hδ hδ'_lt hδ'
  ...
  have hpath :
    ...
    simpa only [U, Φ₀, Φ₁, Φ₂] using
      de_turck_rhs_at_metric_perturbation_sub_eq_path_integrals (I := I) (M := M) g₀ g_bg T T'
