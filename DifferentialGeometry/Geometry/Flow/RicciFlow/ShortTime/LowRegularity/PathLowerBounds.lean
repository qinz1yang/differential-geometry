...
theorem lower_coeff_h1
  ...
  obtain ⟨C₀, hC₀, hzero⟩ := operatorFieldApplication_c1_h2_h1 (I := I) (M := M) hDim g 2 2
  obtain ⟨C₁, hC₁, hone⟩ := operatorFieldApplication_h2_cov_h1 (I := I) (M := M) hDim g 1 2
    ...
    ∃ C : ℝ, 0 ≤ C ∧
      ∀ (Φ₀ : SmoothCcTensor g 2 2) (Φ₁ : SmoothCcTensor g 3 2)
        ...
        ‖ccTensorToHs (I := I) (M := M) g 2 (1 : ℝ)
          ...
          C * (A₀ + A₁) *
            ‖ccTensorToHs (I := I) (M := M) g 2 (2 : ℝ) U‖ := by
  obtain ⟨C₀, hC₀, hzero⟩ := operator_field_application_h1_h2_to_h1_bound
    (I := I) (M := M) (hDim := hDim) (g := g) (r := 2) (c := 2)
  obtain ⟨C₁, hC₁, hone⟩ := operatorFieldApplication_h2_cov_h1
