...
omit [Module.Finite ℝ E] in
theorem exists_metric_subsequence_tendsto_in_derivative_norm_at_countable_times
    [Module.Finite ℝ E]
    (hne : Nonempty M)
    (K : Set M) (hK : IsCompact K) (p : Nat)
...
omit [SigmaCompactSpace M] in
theorem metric_subsequence_cauchy_at_time_of_dense_time_convergence
    [Module.Finite ℝ E]
...
omit [I.Boundaryless] [IsManifold I 1 M] [IsManifold I 2 M]
    ...
    [ContMDiffVectorBundle 1 E (TangentSpace I : M → Type _) I] in
omit [SigmaCompactSpace M] in
theorem metric_sequence_tendsto_of_cauchy_and_subsequence_tendsto
    [Module.Finite ℝ E]
    (K : Set M) (p : Nat)
...
omit [I.Boundaryless] [IsManifold I 1 M] [IsManifold I 2 M] in
omit [SigmaCompactSpace M] in
theorem metric_limit_derivative_norm_lipschitz
    [Module.Finite ℝ E]
    (K : Set M) (beta psiT : Real) (p : Nat)
    (gSeq : Nat -> Real -> SmoothRiemannianMetric I M)
...
omit [I.Boundaryless] [IsManifold I 1 M] [IsManifold I 2 M]
    ...
    [ContMDiffVectorBundle 1 E (TangentSpace I : M → Type _) I] in
omit [SigmaCompactSpace M] in
theorem exists_metric_subsequence_tendsto_uniformly_on_time_interval_of_dense_time_convergence
    [Module.Finite ℝ E]
    (K : Set M) (beta psiT : Real) (p : Nat)
    (gSeq : Nat -> Real -> SmoothRiemannianMetric I M)
    (gInf : Real -> SmoothRiemannianMetric I M) (gRef : SmoothRiemannianMetric I M)
...
structure MetricWindowSubsequence
    (K : Set M) (beta psiT : Real) (p : Nat)
    (gSeq : Nat -> Real -> SmoothRiemannianMetric I M)
...
omit [Module.Finite ℝ E] in
theorem exists_metric_subsequence_tendsto_uniformly_on_time_interval
    [Module.Finite ℝ E]
    (hne : Nonempty M)
...
omit [Module.Finite ℝ E] in
theorem metricWindowSubsequence_of_bounds
    [Module.Finite ℝ E]
    (hne : Nonempty M)
    (K : Set M) (hK : IsCompact K) (beta psiT : Real) (p : Nat)
    (gSeq : Nat -> Real -> SmoothRiemannianMetric I M)
