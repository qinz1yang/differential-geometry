...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
lemma curvatureDecompositionMonomialFib_apply (x : M) (tw : ℝ) (σ : Equiv.Perm (Fin 4))
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
lemma curvatureDecompositionMonomialFib_toModel (x : M) (tw : ℝ) (σ : Equiv.Perm (Fin 4))
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
@[simp] lemma curvatureDecompositionMonomialFib_zero_weight (x : M) (σ : Equiv.Perm (Fin 4))
    (p q : TangentSpace I x) :
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
@[simp] lemma curvatureDecompositionKernelFib_zero_weight (x : M)
    (σ₁ σ₂ σ₃ σ₄ : Equiv.Perm (Fin 4)) (p q : TangentSpace I x) :
    curvatureActionKernelCLM (I := I) (M := M) x 0 σ₁ σ₂ σ₃ σ₄ p q = 0 := by
  rw [curvatureActionKernelCLM, curvatureDecompositionMonomialFib_zero_weight,
    curvatureDecompositionMonomialFib_zero_weight, curvatureDecompositionMonomialFib_zero_weight,
    curvatureDecompositionMonomialFib_zero_weight]
  simp
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
theorem curvatureDecompositionMonomialFibFixedFrame_toModel (W : Π b : M, Tensor0SSpace 2 I b)
    (σ : Equiv.Perm (Fin 4))
    (B : Fin (Module.finrank ℝ E) → Π b : M, TangentSpace I b) (x : M)
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
theorem curvatureDecompositionMonomialFibFixedFrame_apply_section_contMDiff
...
omit [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M] [SigmaCompactSpace M]
    [CompleteSpace E] in
theorem curvatureDecompositionMonomialBiContrFib_contMDiff (g₁ : SmoothRiemannianMetric I M)
    (W : Π b : M, Tensor0SSpace 2 I b)
    (hW : ContMDiff I (I.prod 𝓘(ℝ, Tensor0SModel 2 ℝ E)) ∞
      (fun b : M => TotalSpace.mk' (Tensor0SModel 2 ℝ E)
        (E := fun z : M => Tensor0SSpace 2 I z) b (W b)))
    ...
    have h_glob : ContMDiff I (I.prod 𝓘(ℝ, TensorRSModel 4 2 ℝ E)) ∞
      ...
      apply contMDiff_clm_section_of_pointwise (I := I) (M := M)
        ...
        (φ := fun x : M => curvatureActionMonomialFrameTrace (I := I) (M := M) W σ
          (smoothOrthoFrame (I := I) g₁ x₀) x)
      intro Y
      exact curvatureDecompositionMonomialFibFixedFrame_apply_section_contMDiff (I := I) (M := M)
...
def curvatureActionMonomialCoeffField (g₀ g₁ : SmoothRiemannianMetric I M)
  ...
  toSection :=
    { toFun := fun x : M =>
      ...
      contMDiff_toFun := curvatureDecompositionMonomialBiContrFib_contMDiff (I := I) (M := M)
        g₁ W hW σ }
  hasCompactSupport := HasCompactSupport.of_compactSpace _

omit [I.Boundaryless] [BoundarylessManifold I M] [SigmaCompactSpace M] [CompleteSpace E] in
@[simp] theorem curvatureDecompositionMonomialCoeffField_toSection
...
omit [NeZero (Module.finrank ℝ E)] [CompactSpace M] [I.Boundaryless] [BoundarylessManifold I M]
    [T2Space M] [SigmaCompactSpace M] [CompleteSpace E] in
lemma curvatureDecompositionMonomialBiContrFib_zero_weight (g₁ : SmoothRiemannianMetric I M)
    (W : Π b : M, Tensor0SSpace 2 I b) (σ : Equiv.Perm (Fin 4)) {x : M}
    (hx : W x = 0) :
...
omit [I.Boundaryless] [BoundarylessManifold I M] [SigmaCompactSpace M] [CompleteSpace E] in
theorem curvatureDecompositionKernelCoeffField_toSection_eq_kernelFib_sum
    (g₀ g₁ : SmoothRiemannianMetric I M) (W : Π b : M, Tensor0SSpace 2 I b)
    (hW : ContMDiff I (I.prod 𝓘(ℝ, Tensor0SModel 2 ℝ E)) ∞
      (fun b : M => TotalSpace.mk' (Tensor0SModel 2 ℝ E)
        (E := fun z : M => Tensor0SSpace 2 I z) b (W b)))
...
abbrev curvatureDecompositionMonomialFib (x : M) (tw : ℝ) (σ : Equiv.Perm (Fin 4))
    (p q : TangentSpace I x) :
    Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x :=
  curvatureActionMonomialCLM (I := I) (M := M) x tw σ p q

abbrev curvatureDecompositionKernelFib (x : M) (tw : ℝ)
    (σ₁ σ₂ σ₃ σ₄ : Equiv.Perm (Fin 4)) (p q : TangentSpace I x) :
    Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x :=
  curvatureActionKernelCLM (I := I) (M := M) x tw σ₁ σ₂ σ₃ σ₄ p q

abbrev curvatureDecompositionMonomialFibFixedFrame
    (W : Π b : M, Tensor0SSpace 2 I b) (σ : Equiv.Perm (Fin 4))
    (B : Fin (Module.finrank ℝ E) → Π b : M, TangentSpace I b) (x : M) :
    Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x :=
  curvatureActionMonomialFrameTrace (I := I) (M := M) W σ B x

abbrev curvatureDecompositionMonomialBiContrFib (g₁ : SmoothRiemannianMetric I M)
    (W : Π b : M, Tensor0SSpace 2 I b) (σ : Equiv.Perm (Fin 4)) (x : M) :
    Tensor0SSpace 4 I x →L[ℝ] Tensor0SSpace 2 I x :=
  curvatureActionMonomialTrace (I := I) (M := M) g₁ W σ x

abbrev curvatureDecompositionMonomialCoeffField (g₀ g₁ : SmoothRiemannianMetric I M)
    (W : Π b : M, Tensor0SSpace 2 I b)
    (hW : ContMDiff I (I.prod 𝓘(ℝ, Tensor0SModel 2 ℝ E)) ∞
      (fun b : M => TotalSpace.mk' (Tensor0SModel 2 ℝ E)
        (E := fun z : M => Tensor0SSpace 2 I z) b (W b)))
...
abbrev curvatureDecompositionKernelCoeffField (g₀ g₁ : SmoothRiemannianMetric I M)
    (W : Π b : M, Tensor0SSpace 2 I b)
    (hW : ContMDiff I (I.prod 𝓘(ℝ, Tensor0SModel 2 ℝ E)) ∞
      (fun b : M => TotalSpace.mk' (Tensor0SModel 2 ℝ E)
        (E := fun z : M => Tensor0SSpace 2 I z) b (W b)))
