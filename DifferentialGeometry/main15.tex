...
The final Hamilton endpoint is stated using project-local Lean predicates, as many corresponding definitions not yet exists in Mathlib.
...
\subsubsection{Evolution of the connection}
...
The proof is the fixed-frame component theorem
...
\subsubsection{Evolution of Ricci and scalar curvature}
